                    ...
                    <div class="col-sm-12 col-md-12 col-xl-12">
                        <div class="h-100 bg-secondary rounded p-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <h6 class="mb-0">All Messages last month</h6>
...
PreparedStatement ps3 = con.prepareStatement("SELECT * FROM  customer INNER JOIN message ON customer.customer_ID = message.customer_ID where DATE(message_date) >= DATE_SUB(CURDATE(), INTERVAL 1 month) ");
