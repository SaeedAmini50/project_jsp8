        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>order</a>
                        <div class="dropdown-menu bg-transparent border-0">
                      
                               <a href="user_order.jsp" class="dropdown-item">show all order users</a>
                               <a href="user_order_week.jsp" class="dropdown-item">show order users last week</a>
                               <a href="user_order_month.jsp" class="dropdown-item">show order users last month</a>
                             </div>
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                               ...
                               <a href="user_message.jsp" class="dropdown-item">show all message</a>
                               <a href="user_message_week.jsp" class="dropdown-item">show order users last week</a>
                               <a href="user_message_month.jsp" class="dropdown-item">show order users last month</a>
                             </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-secondary border-0 rounded-0 rounded-bottom m-0">
                                        ...
                                        try{
                                        	...
                                        	PreparedStatement ps3 = con.prepareStatement("SELECT *, TIME(message.message_date) AS message_time FROM customer INNER JOIN message ON customer.customer_ID = message.customer_ID WHERE DATE(message.message_date) = CURDATE()");
                                        	...
                                        	while (rs3.next()) {
                                        	    ...
                                        	    <a href="#" class="dropdown-item">
                                        	        <div class="d-flex align-items-center">
                                        	            <img class="rounded-circle" src="img/user.jpg" alt="" style="width: 40px; height: 40px;">
                                        	            <div class="ms-2">
                                        	                <h6 class="fw-normal mb-0"><%=rs3.getString(3)%><%=" "%><%=rs3.getString(4)%></h6>
                                        	                <small> Date<%=rs3.getString(14)%></small>
                                        	                <small><%=rs3.getString(7)%></small>
                                        	            </div>
                                        	        </div>
                                        	    </a>
                                        ...
                                        %>
                            <a href="user_message.jsp" class="dropdown-item text-center">See all message</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
