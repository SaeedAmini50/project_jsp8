...
%>
            ...
            <div class="container-fluid pt-4 px-4" >
                                    ...
                                    <th scope="col">full_name</th>
                                        <th scope="col">email </th>
                                         ...
                                         <th scope="col">due_date </th>
                                          ...
                                          <th scope="col">status_payment</th>
               ...
               PreparedStatement ps2 = con.prepareStatement("SELECT * FROM customer INNER JOIN orders INNER JOIN payment ON orders.customer_ID = customer.customer_ID AND payment.payment_ID = orders.payment_ID where DATE(order_date) >= DATE_SUB(CURDATE(), INTERVAL 1 MONTH) ");
...
while(rs2.next()){%>
                               ...
                               <td name="date"><%=rs2.getString(18) %></td>
                                <td name="due_date"><%=rs2.getString(20) %></td>
